    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 style="color: #5e35b1; font-size: 28px; margin: 0; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;">Funds Transfers</h1>
            </div>
            <div class="col-sm-6">
            ...
            <div class="card">
              ...
              <div class="card-body table-responsive">
                <table id="example1" class="table table-hover table-bordered table-striped" style="width: 100%; border-collapse: collapse; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; font-size: 14px; background-color: #f9fafb; border-radius: 12px; overflow: hidden;">
                  <thead>
                    <tr style="background: linear-gradient(135deg, #17c0eb, #00d2d3); color: #ffffff;">
                      <th>#</th>
                      <th>Name</th>
                      <th>Acc Number</th>
                      <th>Rate</th>
                        ...
                        <td>
                          <a href="pages_transfer_money.php?account_id=<?php echo $row->account_id; ?>&account_number=<?php echo $row->account_number; ?>&client_id=<?php echo $row->client_id; ?>"
                            style="
                              ...
                              align-items: center;
                              gap: 8px;
                              background: linear-gradient(135deg, #17c0eb, #00d2d3);
                              color: white;
                              padding: 10px 18px;
                              font-size: 14px;
                              font-weight: 600;
                            ...
                            "
                            onmouseover="this.style.transform='translateY(-2px)'; this.style.boxShadow='0 12px 24px rgba(0, 210, 211, 0.4)'"
                            onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='0 8px 20px rgba(0, 210, 211, 0.3)'"
                          >
                            <i class="fas fa-exchange-alt" style="font-size: 16px;"></i>
                            <span style="white-space: nowrap;">Transfer Money</span>
                          </a>
                        </td>
