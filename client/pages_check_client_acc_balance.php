                ...
                <section class="content-header" style="padding: 20px; background: #ffffff; border-bottom: 1px solid #eaeff5;">
                    <div class="container-fluid">
                        <div class="row align-items-center">
                            <div class="col-sm-6">
                                <h1 style="margin: 0; font-weight: 600; color: #2d3748; font-size: 1.8rem;"><?php echo $row->client_name; ?> Account Balance</h1>
                            </div>
                            <div class="col-sm-6">
                                ...
                                <div id="balanceSheet" class="invoice p-4 mb-4" style="background: #fff; border-radius: 12px; box-shadow: 0 6px 18px rgba(0,0,0,0.08);">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="row mt-4">
                                            ...
                                            <div class="col-6">
                                                <p class="lead" style="font-weight: 600; font-size: 18px; color: #2c3e50;">Balance Checked On: <?php echo date('d-M-Y'); ?></p>
                                                <div class="table-responsive">
                                                    <table class="table table-bordered" style="font-size: 14.5px;">
                                                        <tr>
                                        ...
                                        <div class="row no-print mt-4">
                                            <div class="col-12">
                                                <button type="button" id="print" onclick="printContent('balanceSheet');" class="btn btn-success float-right" style="padding: 10px 20px; font-weight: 500; border-radius: 6px;">
