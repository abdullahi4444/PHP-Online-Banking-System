    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 style="color: #5e35b1; font-size: 28px; margin: 0; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;">Withdrawals</h1>
            </div>
            <div class="col-sm-6">
            ...
            <div class="card">
              ...
              <div class="card-body table-responsive">
                <table id="example1" class="table table-hover table-bordered table-striped" style="width: 100%; border-collapse: collapse; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; font-size: 14px; background-color: #f9fafb; border-radius: 12px; overflow: hidden;">
                  <thead>
                    <tr style="background: linear-gradient(135deg, #ee5253, #ff6b6b); color: #ffffff;">
                      <th>#</th>
                      <th>Name</th>
                      <th>Acc Number</th>
                      <th>Rate</th>
                    ...
                    ?>
                      ...
                      <tr>
                        ...
                        <a href="pages_withdraw_money.php?account_id=<?php echo $row->account_id; ?>&account_number=<?php echo $row->account_number; ?>&client_id=<?php echo $row->client_id; ?>"
                          ...
                          "
                          onmouseover="this.style.transform='translateY(-2px)'; this.style.boxShadow='0 12px 24px rgba(255, 107, 107, 0.4)'"
                        ...
                        >
                          ...
                          <i class="fas fa-arrow-circle-down" style="font-size: 16px;"></i>
                          <span style="white-space: nowrap;">Withdraw Money</span>
                        </a>
                      </td>
