      ...
      <section class="content-header" style="padding: 20px; background: #ffffff; border-bottom: 1px solid #eaeff5;">
        <div class="container-fluid">
          <div class="row align-items-center">
            <div class="col-sm-6">
              <h1 style="margin: 0; font-weight: 600; color: #2d3748; font-size: 1.8rem;">iBanking Acount Types</h1>
            </div>
            <div class="col-sm-6">
              <ol style="display: flex; justify-content: flex-end; margin: 0; padding: 0; list-style: none;">
                ...
                <li style="margin-left: 10px;"><a href="pages_manage_accs.php" style="color: #4a5568; text-decoration: none;">/ iBank Account Types / </a></li>
                <li style="margin-left: 10px; color: #a0aec0;">Manage Clients</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
            ...
            <div class="card" style="border: none; border-radius: 12px; box-shadow: 0 4px 16px rgba(0,0,0,0.05); overflow: hidden;">
              <div class="card-header" style="background-color: #fff; padding: 20px 24px; border-bottom: 1px solid #eee;">
                <h3 class="card-title" style="margin: 0; font-size: 18px; font-weight: 600; color: #333;">
                  Select on any action options to manage your account types
                </h3>
              </div>
                ...
                <table id="example1" class="table table-hover table-bordered table-striped"
                  ...
                  <tbody>
                    ...
                    <tr style="transition: background 0.3s;" onmouseover="this.style.backgroundColor='#f9f9f9'" onmouseout="this.style.backgroundColor='#ffffff'">
                      ...
                      <td style="padding: 10px;"><?php echo $row->rate; ?>%</td>
                      <td style="padding: 10px;"><?php echo $row->code; ?></td>
                      <td style="padding: 10px; white-space: nowrap;">
                        <a href="pages_update_accs.php?code=<?php echo $row->code; ?>"
                          style="display: inline-flex; align-items: center; gap: 6px; padding: 8px 18px; background: linear-gradient(135deg, #6a11cb, #2575fc); color: white; border-radius: 8px; text-decoration: none; font-weight: 600; font-size: 14px; box-shadow: 0 4px 12px rgba(38, 66, 255, 0.4); transition: background 0.3s ease, box-shadow 0.3s ease; border: none; cursor: pointer; margin-left: 90px;"
                          onmouseover="this.style.background='linear-gradient(135deg, #2575fc, #6a11cb)'; this.style.boxShadow='0 6px 18px rgba(38, 66, 255, 0.6)';"
                          onmouseout="this.style.background='linear-gradient(135deg, #6a11cb, #2575fc)'; this.style.boxShadow='0 4px 12px rgba(38, 66, 255, 0.4)';">
                          <i class="fas fa-cogs"></i> Manage
                        </a>

                        <a href="pages_manage_accs.php?deleteBankAccType=<?php echo $row->acctype_id; ?>"
                          style="display: inline-flex; align-items: center; gap: 6px; padding: 8px 18px; background: linear-gradient(135deg, #ff416c, #ff4b2b); color: white; border-radius: 8px; text-decoration: none; font-weight: 600; font-size: 14px; box-shadow: 0 4px 12px rgba(255, 65, 108, 0.5); transition: background 0.3s ease, box-shadow 0.3s ease; border: none; cursor: pointer;"
                          onmouseover="this.style.background='linear-gradient(135deg, #ff4b2b, #ff416c)'; this.style.boxShadow='0 6px 18px rgba(255, 65, 108, 0.7)';"
                          onmouseout="this.style.background='linear-gradient(135deg, #ff416c, #ff4b2b)'; this.style.boxShadow='0 4px 12px rgba(255, 65, 108, 0.5)';">
