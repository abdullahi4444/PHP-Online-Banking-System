            ...
            ?>
                <section class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1 style="margin: 0; font-weight: 600; color: #2d3748; font-size: 1.8rem;"><?php echo $row->name; ?> Profile</h1>
                            </div>
                            <div class="col-sm-6">
                                <ol style="display: flex; justify-content: flex-end; margin: 0; padding: 0; list-style: none;">
                                    ...
                                    <li style="margin-left: 10px; "><a href="pages_account.php" style="color: #4a5568; text-decoration: none;">/ Profile /</a></li>
                                    <li style="margin-left: 10px; color: #a0aec0;"><?php echo $row->name; ?></li>
                                </ol>
                            </div>
                        </div>
                    </div><!-- /.container-fluid -->
