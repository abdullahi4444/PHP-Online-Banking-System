  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header" style="padding: 20px; background: #ffffff; border-bottom: 1px solid #eaeff5;">
        <div class="container-fluid">
          <div class="row align-items-center">
            <div class="col-sm-6">
              <h1 style="margin: 0; font-weight: 600; color: #2d3748; font-size: 1.8rem;">iBanking Advanced Reporting : Withdrawal</h1>
            </div>
            <div class="col-sm-6">
              <ol style="display: flex; justify-content: flex-end; margin: 0; padding: 0; list-style: none;">
                ...
                <li style="margin-left: 10px;"><a href="pages_financial_reporting_withdrawals.php" style="color: #4a5568; text-decoration: none;"> / Advanced Reporting / </a></li>
                <li style="margin-left: 10px; color: #a0aec0;">Withdrawal</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
      ...
      <section class="content" style="padding-top: 20px;">
        <div class="row">
          <div class="col-12">
            <div class="card" style="border-radius: 10px; box-shadow: 0 3px 10px rgba(0, 0, 0, 0.05);">
              <div class="card-header" style="background-color: #f8f9fa; border-bottom: 1px solid #dee2e6;">
                <h3 class="card-title" style="font-size: 18px; font-weight: 600;">All Transactions Under Withdrawal Category</h3>
              </div>
              <div class="card-body table-responsive">
                <div class="">
                  <table id="export" class="table table-hover table-bordered table-striped" style="font-size: 14px;">
                    ...
                    <tbody>
                      ...
                      ?>
                        <tr>
                          ...
                          <td><?php echo date("d-M-Y h:i:s A", strtotime($transTstamp)); ?></td>
                        </tr>
                      <?php $cnt++; } ?>
                    </tbody>
                  </table>
