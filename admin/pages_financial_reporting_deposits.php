      ...
      <section class="content-header" style="padding: 20px; background: #ffffff; border-bottom: 1px solid #eaeff5;">
        <div class="container-fluid">
          <div class="row align-items-center">
            <div class="col-sm-6">
              <h1 style="margin: 0; font-weight: 600; color: #2d3748; font-size: 1.8rem;">iBanking Advanced Reporting : Deposits</h1>
            </div>
            <div class="col-sm-6">
              <ol style="display: flex; justify-content: flex-end; margin: 0; padding: 0; list-style: none;">
                ...
                <li style="margin-left: 10px;"><a href="pages_financial_reporting_deposits.php" style="color: #4a5568; text-decoration: none;"> / Advanced Reporting / </a></li>
          ...
          <div class="col-12">
            <div class="card" style="border-radius: 10px; box-shadow: 0 3px 10px rgba(0, 0, 0, 0.05);">
              <div class="card-header" style="background-color: #f8f9fa; border-bottom: 1px solid #dee2e6;">
                <h3 class="card-title" style="font-size: 18px; font-weight: 600;">All Transactions Under Deposits Category</h3>
              </div>
